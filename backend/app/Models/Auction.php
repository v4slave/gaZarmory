...
{
    protected $fillable=['treasury_item_id','quantity','starting_bid','minimum_step','ends_at','status','winner_player_id','winning_bid','created_by','finished_at','extension_minutes','extensions_count','token_unit_value_snapshot'];
    protected function casts():array{return['ends_at'=>'immutable_datetime','finished_at'=>'immutable_datetime','token_unit_value_snapshot'=>'integer'];}
