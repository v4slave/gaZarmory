...
{
    protected $fillable = ['nickname', 'class', 'is_active', 'group_id', 'gear_score', 'previous_gear_score', 'gear_score_updated_at', 'archa_gear_url', 'archa_gear_items', 'archa_gear_updated_at', 'has_ship', 'has_tank', 'has_fuchsias', 'has_clouds', 'has_machaon', 'has_tare', 'has_deer', 'has_invulnerable_pet', 'has_shield_swap', 'has_flippers'];
