...
1. Расчёт основного или мини-прайма блокирует activity, проверяет непустой состав и отсутствие существующих earnings, затем создаёт snapshots по оценочной стоимости лута. Золотой ledger при этом не изменяется.
