...
<template>
  <section class="dashboard-page">
    ...
    <div class="stats-row dashboard-main-stats"><StatCard label="Золото в казне" :value="Number(data.gold).toLocaleString('ru-RU')" gold note="Фактический баланс" accent/><StatCard label="Дроп с РБ" :value="Number(data.inventory_value).toLocaleString('ru-RU')" gold note="Эквивалент в золоте"/><StatCard label="Ожидаемый нахрюк" :value="Number(data.pending_payout).toLocaleString('ru-RU')" gold/><StatCard label="Средний ГС гильдии" :value="Number(data.average_gear_score).toLocaleString('ru-RU')"/><StatCard label="Активных аукционов" :value="data.active_auctions"/></div>
