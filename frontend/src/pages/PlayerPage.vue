...
const assetLabels = { has_ship:'Корабль', has_tank:'Танк', has_fuchsias:'Фуксории', has_clouds:'Облачка', has_machaon:'Махаон', has_tare:'Таре', has_deer:'Олень', has_invulnerable_pet:'Пет на неуяз', has_shield_swap:'Свап на щит', has_flippers:'Ласты' }
