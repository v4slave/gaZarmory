...
const translations = {
  ...
  'Сбросьте или измените активные фильтры.': 'Reset or change the active filters.',
  'В составе пока нет игроков': 'There are no players in the roster yet',
  'Добавьте первого персонажа в состав гильдии.': 'Add the first character to the guild roster.',
  'Поиск:': 'Search:', 'Класс:': 'Class:', 'Событие выбрано': 'Event selected',
  'Убрать событие': 'Remove event', 'Убрать начальную дату': 'Remove start date', 'Убрать конечную дату': 'Remove end date',
  'Сбросить фильтры': 'Reset filters',
  'событий': 'events', 'С:': 'From:', 'По:': 'To:', 'Страницы': 'Pages',
  'Не удалось подключиться к серверу. Проверьте соединение и попробуйте снова.': 'Could not connect to the server. Check your connection and try again.',
  ...
  'Основное': 'Main', 'Экономика': 'Economy', 'Доп. функционал': 'More', 'Выберите раздел': 'Choose a section', 'Управление': 'Management', 'Главная': 'Home', 'Состав': 'Roster',
  ...
  'Нет доступа': 'Access denied', 'Страница не найдена': 'Page not found', 'Вернуться на главную': 'Back to home',
  ...
  'БЛИЖАЙШИЕ СОБЫТИЯ': 'UPCOMING EVENTS', 'БЛИЖАЙШЕЕ СОБЫТИЕ': 'NEXT EVENT', 'Ближайших событий нет.': 'No upcoming events.', 'Неделя гильдии': 'Guild week', 'Расписание': 'Schedule', 'Экспериментальный интерфейс': 'Experimental interface', 'Ворованное армори': 'Stolen Armory', 'Открыть свой профиль': 'Open your profile', 'Открыть профиль': 'Open profile', 'Открыть событие': 'Open event', 'Открыть Discord гильдии': 'Open guild Discord', 'ИНСТРУМЕНТ': 'TOOL', 'Калькулятор': 'Calculator', 'Калькулятор шмота персонажа': 'Character gear calculator', 'Соберите комплект и рассчитайте характеристики персонажа на archa.ge': 'Build a gear set and calculate character stats on archa.ge', 'Открыть калькулятор': 'Open calculator', 'Не удалось загрузить дашборд.': 'Failed to load dashboard.',
  ...
  'Добавить участников со скриншота': 'Add participants from screenshot', 'OCR · РАСПОЗНАВАНИЕ СОСТАВА': 'OCR · ROSTER RECOGNITION',
  'Загрузите скрин рейд-фреймов. Проверьте найденные совпадения перед добавлением.': 'Upload a raid-frame screenshot. Review the matches before adding them.',
  'Выбрать скриншот': 'Choose screenshot', 'PNG, JPG или WEBP · до 12 МБ': 'PNG, JPG or WEBP · up to 12 MB', 'Загруженный скриншот': 'Uploaded screenshot',
  'Распознаём…': 'Recognizing…', 'Распознать ники': 'Recognize nicknames', 'Найдено совпадений:': 'Matches found:',
  'Выбрать всех': 'Select all',
  'Совпадений с активным составом не найдено. Попробуйте более чёткий скриншот.': 'No matches with the active roster were found. Try a clearer screenshot.',
  'Не удалось распознать участников.': 'Could not recognize participants.', 'Добавлено участников со скриншота: .': 'Participants added from screenshot: .',
