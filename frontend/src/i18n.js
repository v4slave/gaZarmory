...
const translations = {
  ...
  'БЛИЖАЙШИЕ СОБЫТИЯ': 'UPCOMING EVENTS', 'Неделя гильдии': 'Guild week', 'Экспериментальный интерфейс': 'Experimental interface', 'Не удалось загрузить дашборд.': 'Failed to load dashboard.',
