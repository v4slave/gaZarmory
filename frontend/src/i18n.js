...
const translations = {
  ...
  'Фон баннера': 'Banner background', 'Изображение или GIF': 'Image or GIF',
  'JPG, PNG, WebP или GIF, до 10 МБ': 'JPG, PNG, WebP, or GIF, up to 10 MB',
  'Использовать стандартный фон': 'Use default background',
  'Выберите JPG, PNG, WebP или GIF размером до 10 МБ.': 'Choose a JPG, PNG, WebP, or GIF up to 10 MB.',
