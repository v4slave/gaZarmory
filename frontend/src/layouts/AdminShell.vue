...
.admin-workspace{background:linear-gradient(rgba(2,2,2,.5),rgba(4,3,2,.66)),url('/images/gaz-armory-noir-background.png') center/cover fixed}.admin-workspace-top{border-bottom-color:rgba(229,167,74,.44);background:rgba(14,12,9,.96)}
</style>
